...
-   Recording of analytics events - search and clicks. [Read more](/docs/reactivesearch/vue/v1/advanced/analytics/).
...
Read more about it over [here](/docs/reactivesearch/vue/v1/advanced/analytics/#configure-the-analytics-experience).
...
allows over-writing of default styles by providing the respective key/values. You can read more about its usage [here](/docs/reactivesearch/vue/v1/theming/overview/)
### transformRequest
...
-   List specific components can be found [here](/docs/reactivesearch/vue/v1/list/singlelist/).
-   Range specific components can be found [here](/docs/reactivesearch/vue/v1/range/singlerange/).
-   Search specific components can be found [here](/docs/reactivesearch/vue/v1/search/datasearch/).
-   Result specific components can be found
    [here](/docs/reactivesearch/vue/v1/result/resultlist/).

You can read more about when to use which components in the overview guide [here](/docs/reactivesearch/vue/v1/overview/components/).
