...
The selected range value is reactively updated pertaining to the changes in `range-selector` and displayed using [SelectedFilters](/docs/reactivesearch/flutter-searchbox-ui/selected-filters/)
