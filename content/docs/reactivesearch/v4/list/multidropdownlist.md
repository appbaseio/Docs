...
> Note
>
> This component is exactly like the [MultiList](/docs/reactivesearch/v4/list/multilist/) component except the UI is based on a dropdown, ideal for showing additional UI filters while conserving screen space.
