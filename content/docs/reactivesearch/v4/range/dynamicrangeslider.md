...
> Note
>
> This component behaves similar to the [RangeSlider](/docs/reactivesearch/v4/range/rangeslider/) except that the range is computed dynamically based on actual data.
