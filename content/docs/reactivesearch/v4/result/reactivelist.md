...
Read more about the usage [here](/docs/reactivesearch/v4/result/resultcard/#usage).
### ResultListWrapper
A wrapper component for `ResultList` components to render a list based layout.
Read more about the usage [here](/docs/reactivesearch/v4/result/resultlist/#usage).
