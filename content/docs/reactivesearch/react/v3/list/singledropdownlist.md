...
> Note
>
> This component is exactly like the [SingleList](/docs/reactivesearch/react/v3/list/singlelist/) component except the UI is based on a dropdown, ideal for showing additional UI filters while conserving screen space.
