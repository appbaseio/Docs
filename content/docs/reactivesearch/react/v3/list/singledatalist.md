...
> Note
>
> This component is like the [SingleList](/docs/reactivesearch/react/v3/list/singlelist/) component except the filters are set based on the `data` prop, ideal for showing custom UI filters in a list layout.
