...
> Note
>
> This component behaves similar to the [MultiList](/docs/reactivesearch/react/v3/list/multilist/) component except the list items are user defined with the `data` prop, ideal for showing curated items in a list layout.
