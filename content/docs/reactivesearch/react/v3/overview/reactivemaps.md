...
> Existing users can checkout the [migration guide](https://docs.appbase.io/docs/reactivesearch/react/v3/advanced/migration/#reactivemaps) to switch to the newest version of ReactiveMaps library.
...
Lets add our first ReactiveSearch component: [ReactiveBase](/docs/reactivesearch/react/v3/overview/reactivebase/), it is a backend connector where we can configure the Elasticsearch index / authorization setup.
...
For this app, we will be using [SingleList](/docs/reactivesearch/react/v3/list/singlelist/) component for filtering the dataset. And [ReactiveGoogleMap](/docs/reactivesearch/react/v3/map/reactivegooglemap/) component for showing the search results.
...
Next, we will look at the [**ReactiveGoogleMap**](/docs/reactivesearch/react/v3/map/reactivegooglemap/) component for creating a map component.
...
You can also customise it to render any kind of marker pins. Refer [ReactiveGoogleMap's documentation](/docs/reactivesearch/react/v3/map/reactivegooglemap/) for the same.
