...
> Note
>
> It is exactly like the [MultiRange](/docs/reactivesearch/react/v3/range/multirange/) component but displayed in a dropdown, ideal for showing additional UI filters while conserving screen space
