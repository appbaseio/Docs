...
> Note
>
> This component behaves similar to the [RangeSlider](/docs/reactivesearch/react/v3/range/rangeslider/) except that the range is computed dynamically based on actual data.
