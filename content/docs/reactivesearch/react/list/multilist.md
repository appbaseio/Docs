...
`MultiList` creates a multiple selection based list UI component that is connected to a database field. It is similar to a [SingleList](/docs/reactivesearch/react/list/singlelist/) except it can support multiple item selections.
