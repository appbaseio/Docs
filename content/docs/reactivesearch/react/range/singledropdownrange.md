...
> Note
>
> This component is exactly like the [SingleRange](/docs/reactivesearch/react/range/singlerange/) component except the UI is based on a dropdown, ideal for showing additional UI filters while conserving screen space.
