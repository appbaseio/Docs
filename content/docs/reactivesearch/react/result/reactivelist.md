...
Read more about the usage [here](/docs/reactivesearch/react/result/resultcard/#usage).
### ResultListWrapper
A wrapper component for `ResultList` components to render a list based layout.
Read more about the usage [here](/docs/reactivesearch/react/result/resultlist/#usage).
